...
> 배열 길이 읽기 ([§10.7](https://docs.oracle.com/javase/specs/jls/se21/html/jls-10.html#jls-10.7)), 체크된 캐스트 실행 (§5.5, [§15.16](§15.16)), 가상 메서드 호출 (§15.12) 같은 스레드 간 동작이 아닌 연산의 의미는 데이터 경쟁에 의해 직접적으로 영향을 받지 않습니다.
